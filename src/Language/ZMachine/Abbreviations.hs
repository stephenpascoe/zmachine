...
import Language.ZMachine.ZSCII (AbbreviationTable, ZsciiString, decodeZString)
...
displayAbbreviations aTable = mconcat $ zipWith (curry buildEntry) [0 ..] (V.toList aTable) where
